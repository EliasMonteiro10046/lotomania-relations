...
@section('index')
    ...
    <table class="table table-striped">
        ...
        <tr>
            <th scope="col">#</th>
            <th scope="col">Identificador Concurso</th>
        ...
        <tbody>
            @foreach ( $concursos as $concurso)
                <tr>
                    ...
                    <td width="200px">
                        <div class="acoes">
                            <a class="btn btn-success" href="{{ route('concurso.acertos', $concurso->id)}}" >Acertos</a>
                            <a class="btn btn-danger" href="{{ route('concurso.show', $concurso->id)}}" >Erros</a>
